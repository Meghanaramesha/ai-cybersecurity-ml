...
# Supercell’s Floodrush: First look! User Acquisition & game design review
...
Floodrush is a unique blend of battle royale and Clash Royale-style unit placement, showcasing Supercell’s innovative approach to mobile game design. As players progress, their power and army size grow, reflecting a core gameplay mechanic that Supercell has iterated on across titles like Squad Busters. The game’s focus on player progression and strategic unit deployment creates an engaging experience, where mastering controls and tactics is essential to success. With Floodrush, Supercell continues to push the boundaries of mobile gaming by combining familiar elements with new dynamics, making it a standout title for both players and user acquisition strategies.  
![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-09-at-05.32.05.png)

![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-09-at-05.32.18.png)

![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-09-at-05.34.09.png)

![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-09-at-06.01.41.png)

![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-09-at-05.52.02.png)

## What is the soft launch strategy for Supercell’s Floodrush, and how does it optimize game performance before global release?

Floodrush was soft-launched in English-speaking regions, including the United States, United Kingdom, Canada, New Zealand, and Singapore. Unlike Squad Busters, which was developed by one team at Supercell, Floodrush is created by a different development team within the company.

This game was soft-launched in English-speaking geos:

**US, UK, CA, NZ & SG**

This game is developed by a different CELL than [Squad Busters](https://lancaric.me/squad-busters-supercell-softlaunch/). 

﻿﻿

Let the Hunger Games begin! Only one game can survive, right?

Anyway, let’s get back to Supercell’s soft launch formula. Before we compare Squad Busters with Floodrush and their approach, let’s take a step back and look at what is possible on Android for [soft launching your game](https://lancaric.me/how-to-soft-launch-a-mobile-game-in-2022/). I took few slides from my last year’s presentation at DOF & Google with Nimrod.
...
## Why is user acquisition crucial for open beta games like Floodrush without established IPs?

User acquisition is crucial for open beta games like Floodrush without established IPs because it helps attract and engage players, driving downloads and user retention.
...
Thank you [mobileaction](http://mobileaction.co) for providing the insights! The only tool where I found the creatives!

![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-07-at-06.16.12.png)

## How can varied creative concepts boost marketing performance in mobile game open betas?

## 

Diversifying creative concepts can significantly enhance marketing performance in mobile game open betas by attracting a broader audience, improving engagement, and increasing brand visibility.

It was a mix of static images & videos. You can get away with 10 creatives for a limited amount of time in the open beta f**rom May 29 – June 7.**
...
* *Minions were hard to understand: Their characteristics, behaviors and abilities were not obvious, and because there were so many of them at once it was difficult to observe what was going on. They’re not as orthogonal as Squad Busters.*  
  *The octopus is a shotgun unit apparently! Who would tell!? You need to go to a submenu to understand that!*
...
* *Despite the variety in maps, the pattern felt repetitive: Loot and then clash in the center. I didn’t feel there were many mechanics in the maps to master, contrary to League of Legends map monsters.*  
  *And because the maps change, it didn’t encourage mastery.*
* *Additionally, it’s quite challenging to understand what elements in the map are intractable/destroyable and which don’t… they all look the same. A barrel is destroyable but a box next to it that looks the same isn’t OK. The drops seem quite arbitrary as well.*  
  *If I understood correctly, the expected dynamics is to observe the opponents buildup, and then adapt yours consequently for the end clash.* *I think that’s cool but the range of options during the match to do this is fairly limited.*
...
We also asked our good friend [Javier Barnes](https://www.linkedin.com/in/javier-barnes-8b0b5424/) & guess what:

## **Javier prefers** ***Squad Busters***

**I didn’t enjoy the** ***Floodrush*** **beta too much**.   
There are some interesting ideas in *Floodrush*. But I believe most of them – if not all – are currently executed way better in *Squad Busters*.
