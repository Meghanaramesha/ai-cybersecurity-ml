...
![What metrics should you care about when evaluating your UA success?](https://lancaric.me/wp-content/uploads/2023/05/stiahnut-1.png) 

# What metrics should you care about when evaluating your UA success?
...
## Importance of Installs in User Acquisition Metrics
...
## Cost Per Install (CPI) in App Marketing

Is **the rate you pay to acquire new users through app installations**. CPI is calculated by dividing ad spend by the total number of app installs associated with a campaign. This metric can grow [audiences](https://lancaric.me/how-to-use-facebook-lookalike-audiences-the-complete-guide/), increase revenue, and inform your advertising budget. You can calculate it by  dividing ad spend by number of installs.The average CPI will differ by a number of factors such as country, platform, and ad format. It’s important as it allows them to create targeted campaigns.

## Daily Active Users (DAU) in App Engagement

Daily Active Users, or DAU, is the measurement of the number of users who are active on an app or a game each day. It is a tool used to measure the success of an online product or website. In gaming you can see it as the total number of unique players who complete an action in an app on a given day . You can count it with the number of unique players in a 24-hour period. Use this to check whether your mobile game is part of a user’s daily life.

![](https://lancaric.me/wp-content/uploads/2021/08/stiahnuť-2.png)

## Monthly Active Users (MAU) and Stickiness Ratio
...
## App Load Time and User Experience
...
## Drop-off Rate and Player Retention
...
## Average Transaction Value (ATV) and Monetization
...
## Average Revenue Per Daily Active User (ARPDAU) and Daily Monetization
...
Be sure to track before and during user acquisition campaigns. During a [campaign](https://lancaric.me/step-by-step-guide-for-launching-your-first-facebook-campaign/), segment new users by acquisition source so you can gauge which channels and campaigns perform best.

## Average Revenue Per Paying User (ARPPU) and Revenue Insights
...
## Churn Rate and Player Retention Insights
