# two & half gamers session #7 - Is Axie infinity dead? LTV in crypto gaming & web3 UA/marketing  – Matej Lancaric: User Acquisition Expert to Grow Mobile Games Globally 🦄🕺

![](https://lancaric.me/wp-content/uploads/2023/05/session-7.png) 
...
Special Guest: [Nicolas Vereecke](https://www.linkedin.com/in/nicolasvereecke/)
...
Buy crypto assets first to even play – Browser/PC only (Axie infinity, Crypto Raiders) Download the game for free (find out about the secret crypto layer somehow from the game website – sell NFTs there) (Thetan Arena) Have the game on the store and streamline the funnel to crypto wallet [Skyweaver](https://play.google.com/store/apps/details?id=net.skyweaver.android) Have a functional F2P game with F2P economy and implement the crypto layer into a later stage of the player progression – Future in hybrid? ([Chromatic Souls: Afk Raid](https://chromaticsouls.c2x.world/en#main), Axie Origin?)
...
https://www.youtube.com/watch?v=cpR3YZBB5Us
