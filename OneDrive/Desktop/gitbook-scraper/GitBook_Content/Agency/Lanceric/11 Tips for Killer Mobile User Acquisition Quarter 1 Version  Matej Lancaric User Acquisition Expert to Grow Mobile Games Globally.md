...
# 11 Tips for Killer Mobile User Acquisition (Quarter 1 Version)
...
In quarter 1 of 2024, mobile game user acquisition has seen rapid advancements and evolving trends, reshaping how developers connect with players. Our ongoing series of quarterly UA Tips have explored the latest strategies, technologies, and industry shifts in user acquisition providing insights that help mobile game marketers stay ahead of the competition and maximize ROI more effectively.  
To effectively boost return on ad spend (ROAS) in mobile game marketing, a combination of creative iteration strategies, optimal budget distribution, and leveraging creative depth is crucial. When launching GEO-specific campaigns, evaluating Facebook ad advice and managing budget splits between iOS and Android helps in targeting high-value markets effectively. For user acquisition (UA), starting with user-generated content (UGC) creatives and analyzing competitor ads can lead to more refined creative approaches. High-engagement social media posts, particularly on platforms like TikTok, can further enhance UA campaigns, especially when employing effective TikTok strategies tailored for 2023. Additionally, launching Google hybrid ROAS campaigns provides a solid base for acquiring high-LTV users. Managing ad spend, especially when one creative is dominating, and tapping into insights from experienced communities like the 2.5 Gamers Slack channel can guide the execution of successful Facebook iOS campaigns.

## Creative Iteration Strategies for Boosting ROAS

For some reason, I [have been talking a lot about creatives](https://lancaric.me/creative-framework-in-the-post-idfa-world/). Oh, wait. I know why! Because it makes or breaks your ROAS. You can see below the power of a creative iteration.
...
I added these video examples to the paid newsletter – [visit this link to check out the hybrid casual playbook](https://lancaric.substack.com/p/hybrid-casual-ua-playbook-real-data) and upgrade to paid!
...
## Creative Depth in Mobile Game Marketing

When we review games on our [2.5gamers podcast](http://lancaric.me/yt), I am always talking about **a creative depth**. What does that even mean? You should have a variety of different concepts in your creative strategy. It’s actually not that hard. Let’s look at a few examples:
...
* altered gameplay
* Upgrade/level up
* [Fake ads](https://lancaric.me/fake-ads-in-user-acquisition-the-untold-story/)
* hypercasual-led
* playables

Quite a long list, right? Try to aim to always have at **least three, but ideally five different** concepts in your campaigns.

## Evaluating Facebook Ads Advice for GEO-Specific Campaigns in Mobile Games
...
## Getting Started with UGC Creatives
...
![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd5370394-940e-4240-8973-c984cc9d6c88_2324x1234.png)
...
## Leveraging High-Engagement Social Media Posts for User Acquisition Campaigns
...
Get your top engaged posts from all social media (3-5 up to you) and add them to your business-as-usual [User Acquisition campaigns](http://lancaric.me/)across the board.
...
![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3de00d4f-6938-4249-abf8-638f2645b5bf_713x432.png)

I’ve already talked about it several times before, but it works quite well!

## Guidelines for Launching Google Hybrid ROAS Campaigns

Google hybrid ROAS campaign type is out for everybody! Jump on ASAP!

Thanks a lot, Andrey. Here are guidelines for you!

1. The ad\_impression event must be **the original one** ht<tps://firebase.google.com/docs/analytics/measure-ad-revenue>, in this hybrid tROAS case no custom event should be considered by ML (machine learning, not Matej Lancaric XXOXOXOXO) as an ad revenue event
...
## Effective TikTok Strategies for User Acquisition in 2023
...
![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F31edac69-8efb-4f9e-bbfb-540f846f6b11_2448x964.jpeg)
...
## Managing Ad Spend When One Creative Dominates

What to do when you see one creative getting the majority of spend?

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F08337f51-65f3-417f-95f8-e6e0da4b5f6b_1696x1045.png)
...
## Insights from the 2.5 Gamers Slack Channel on Facebook iOS Campaign Strategies

Picking up some questions from our **2.5 gamers slack channel** (which you should definitely join [here](https://join.slack.com/t/two-and-half-gamers/shared_invite/zt-29stniv6f-oLJzhx2U_mRB_ppXnJ9hvQ)!) that I feel are important for many other people. **Here are my tips:**
