...
![Supercell's Mo.co First Look](https://lancaric.me/wp-content/uploads/2023/11/Screen-Shot-2023-11-02-at-21.47.23.png) 

# Supercell’s Mo.co – First Look! User Acquisition & Game Design Review
...
Supercell’s Mo.co – Closed Beta discusses the mobile gaming giant’s latest entry into the action RPG genre, blending innovative gameplay with familiar mobile-optimized mechanics. Mo.co features an isometric view and a strong PvE focus, where players embark on a nonlinear progression journey through expansive maps.

As part of Supercell’s development approach, Mo.co is in a closed beta phase, allowing for valuable user feedback, which will likely influence future updates. Mo.co’s core mechanics emphasize the RPG trinity of tank, healer, and DPS roles, which introduces more complexity compared to typical mobile games.

Supercell’s strategic iteration during beta testing, which includes fine-tuning gameplay and testing potential monetization models like “Moco Plus,” highlights its high-risk development strategy, with many games not making it past the soft launch phase. As a result, Mo.co exemplifies Supercell’s unique ability to adapt complex RPG mechanics to mobile devices, ensuring accessibility while maintaining deep gameplay for engaged users.

Well, I guess there is always an 80% chance the new game in the soft launch will fail. **Mo.co, let’s discuss this more!**

### What is Supercell’s Mo.co All About?

Supercell’s Mo.co is a mobile action RPG developed by Supercell. It features an isometric view and focuses heavily on Player vs Environment (PvE), with missions and nonlinear progression through large, explorable maps.
...
![](https://lancaric.me/wp-content/uploads/2023/11/WhatsApp-Image-2023-10-31-at-14.59.17.jpeg)
...
![](https://lancaric.me/wp-content/uploads/2023/11/Screen-Shot-2023-11-02-at-21.47.35.png)

The graphics are amazing and the whole ergonomy UI design is really top-notch, up to [Supercell](https://lancaric.me/supercell-floodrush-user-acquistion-game-design/)‘s usual standards. It is also important to note that this game could be a continuation of the previously long before announced Clash Heroes, which looked really similar. Lately, we have seen multiple games without the “Clash” universe, such as Everdale, [Flood Rush](https://lancaric.me/supercell-floodrush-user-acquistion-game-design/), and now Mo.Co. I guess Supercell is really trying hard to diversify the audience, as they don’t want to end up just moving ppl over between their own games. 

![](https://lancaric.me/wp-content/uploads/2023/11/WhatsApp-Image-2023-10-31-at-14.59.17-1.jpeg)
...
![](https://lancaric.me/wp-content/uploads/2023/11/WhatsApp-Image-2023-10-31-at-14.59.15.jpeg)
...
![](https://lancaric.me/wp-content/uploads/2023/11/Screen-Shot-2023-11-02-at-21.57.12.png)
...
![](https://lancaric.me/wp-content/uploads/2023/11/Screen-Shot-2023-11-02-at-21.47.46.png)
...
## What are the Pre-launch Aspects and Key Features of Supercell’s Mo.co in its closed beta phase?

The pre-launch aspects and key features of Supercell’s Mo.co in its closed beta phase focus on testing core mechanics, refining user experience, and gathering player feedback to optimize gameplay.

Anyway, let’s get back to Supercell’s soft launch formula. When we compare [Squad Busters](https://lancaric.me/squad-busters-supercell-softlaunch/) with [Floodrush](https://lancaric.me/supercell-floodrush-user-acquistion-game-design/) and Mo.co – Well, Floodrush was already killed, but Squad Busters still remained in the “darkness”. All in all, open beta didn’t work for Floodrush, but closed beta did work for Squad Busters. Judging only from the point of the killing! Let’s take a step back and look at what is possible on Android for [soft launching your game](https://lancaric.me/how-to-soft-launch-a-mobile-game-in-2022/).

![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-07-at-21.54.56.png)
...
![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-07-at-21.55.03.png)
...
![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-07-at-21.55.26.png)
...
![](https://lancaric.me/wp-content/uploads/2023/06/Screen-Shot-2023-06-07-at-21.55.44.png)
...
## What is My Opinion on User Acquisition of Supercell’s Mo.co?
...
### What is the Feedback of a Mo.co Soft launch Player?

Feedback of a Mo.co Beta Launch player is as followed:
...
## What is the Mo.co Rating for this Closed Beta?

Mo.co rating of this closed beta is as followed:
...
## What is the Difference Between the First Look of Mo.co and Squad Buster?

The first look at Supercell’s mo.co highlights a new approach in game mechanics and player engagement compared to Supercell’s squad buster. While mo.co leans into a more immersive, strategic gameplay design that encourages long-term player investment, squad buster offers a fast-paced, action-oriented experience, aimed at delivering quick thrills through its initial soft launch. Supercell’s squad buster first look for soft launch emphasizes its focus on fast, engaging rounds where players can quickly jump in and compete, whereas mo.co seems designed for players who enjoy exploring layered strategies and detailed mechanics over a longer session. The distinction lies in mo.co’s emphasis on depth and complexity, where every move can shape future outcomes, while squad buster promotes rapid, reflex-based gameplay.

From a game design perspective, mo.co also introduces unique mechanics, such as adaptive challenges and player progression, making it appealing to players who value in-depth, skill-based mastery. In contrast, Supercell’s squad buster first look for soft launch showcases more straightforward gameplay with immediate feedback, aiming to draw in a broader audience through its simplicity and instant gratification. Both games leverage Supercell’s innovative use of user acquisition strategies, yet the target experiences differ: mo.co is tailored for users seeking sustained engagement, whereas squad buster appeals to those who prefer swift, casual play sessions. This differentiation highlights Supercell’s strategic expansion into varied player preferences through its unique, genre-specific offerings.

Difference Between First Looks: Mo.co vs. Squad Busters is as followed:

| Aspect | Mo.co | Squad Busters |
| --- | --- | --- |
| **Developer** | Supercell | Supercell |
| **Genre** | Monster-hunting MMORPG | Party action game |
| **Gameplay Overview** | Players hunt monsters, explore dungeons, and engage in cooperative play. | Fast-paced multiplayer matches where 10 players compete to collect and hold the most gems. |
| **Art Style** | Isometric view with detailed environments and character designs. | Colorful, cartoonish graphics featuring characters from various Supercell games. |
| **Unique Features** | Strong social elements, cooperative monster hunting, and dungeon exploration. | Crossover of characters from Clash of Clans, Brawl Stars, Hay Day, Clash Royale, and Boom Beach. |
| **Platforms** | Mobile devices | Mobile devices |
| **Release Status** | Limited-time beta testing in select regions. [Pocket Gamer](https://www.pocketgamer.com/mo-co/open-beta/?utm_source=chatgpt.com) | Soft-launched on April 23, 2024, with plans for global release. [Supercell](https://supercell.com/en/news/squad-busters-is-soft-launching/?utm_source=chatgpt.com) |
| **Monetization** | Details not fully disclosed; likely to include in-app purchases. | Includes in-app purchases and potential for cosmetic items. |
| **Community Reception** | Positive feedback on engaging gameplay and social features. [Mobile Gamer](https://mobilegamer.biz/the-supercell-magic-is-back-first-impressions-of-mo-cos-limited-time-beta/?utm_source=chatgpt.com) | Enthusiastic responses to character crossovers and fast-paced action. [Lancaric](https://lancaric.me/squad-busters-supercell-softlaunch/?utm_source=chatgpt.com) |
