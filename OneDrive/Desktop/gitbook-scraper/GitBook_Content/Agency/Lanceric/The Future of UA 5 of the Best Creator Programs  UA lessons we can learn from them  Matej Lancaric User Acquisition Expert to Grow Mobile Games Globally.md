...
### Rush Royale Creator Program Requirements

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F19099511-6c50-47bb-9d82-0f9e11d69c02_1176x928.png)

## Supercell opens its doors to more creators

In 2018, [Supercell](https://lancaric.me/supercell-ua-lessons-creatives/) brainstormed with OG content creators and asked what they wanted. This led to creating a creator portal with a tiered rewards system and creator codes. Since its inception, Supercell has recruited over 1,000 creators, and they claim some creators even grew viewership by 600%.

Their robust creator program offers the following benefits:

* Creators Discord channel to share tips, knowledge, and network
* First access to previews and create content before it launches
* Video inboxes – players can watch your content within the game
* Earn money for in-store and in-app purchases with Creator Boost code
* Exclusive first looks, tools, and access to supercell support
* Creator academy: library of video content and bonuses for answering quizzes
* Fan kit media kits

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fde73d2e5-07e6-4230-b24f-da890865a2cf_1000x563.png)
...
### Supercell Creator Program Requirements

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F73af7810-fe68-41bf-a20f-3f1f6ae90956_2385x1194.png)
...
![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1e5501db-1fe2-47c2-b53e-6a75cb505d0b_582x237.png)

ha! [Two & a half gamers](http://lancaric.me/yt) fit the YouTube requirements!

Once [applied](https://creators.supercell.com/en), a Content Manager will review your content to determine whether it meets their quality and behavior guidelines. **Ah fucking hell.. there is always a catch!**

## Epic vows to give 40% of net revenue back to creators

Epic recently announced its [Creator Economy 2.0](https://www.theverge.com/2023/3/22/23645633/fortnite-creator-economy-2-0-epic-games-editor-state-of-unreal-2023-gdc), which is a plan to distribute 40% of Fortnite’s revenues to eligible creators who publish games on Fortnite. The money pool will be from real money spent on Fortnite, purchases of V-bucks, real money transactions (Starter Packs, Quest Packs, Cosmetics), and Fortnite Crew Subscriptions. This excludes the fees paid for licensing.

Similar to Roblox’s creator program that rewards developers for creating experiences through their Fortnite Creative or UEFN engine library. This program runs alongside their popular [Support-a-Creator program](https://sac.epicgames.com/en-US/overview), which provides creators with unique codes that players can enter when making a purchase. This allows players to support their favorite creators without having to donate directly, as the creator code gives the creator a commission through real-money payouts. However, the Support-a-Creator program is now removed from custom islands because creators will now be paid based on the number of players playing them.

**(This video explains everything perfectly)**

Engagement [payouts](https://create.fortnite.com/news/introducing-the-creator-economy-2-0?team=personal) are based on two factors:

* Player popularity: attract new players, re-engage lapsed players
* Player retention: players return day-to-day or week-to-week because o compelling gameplay

Fortnite also launched a dedicated[Creator Portal](https://create.fortnite.com/welcome?lang=en-US&team=personal) with tools and resources to help creators connect with their communities.
...
### Epic Creator Economy 2.0 Requirements
...
* The creator’s Epic account:
  + Must be at least 30 days old before applying, and at least 7 of the last 30 days must have included time editing in Fortnite Creative, Unreal Editor for Fortnite (UEFN) and/or Unreal Engine  
    OR
  + Spent and redeemed $73 (based on USD prices) in the last 90 days on Fortnite in-game products. Gift cards and V-bucks do not apply to this spending threshold. Note that it may take up to 24h for spending and redemption to be reflected.
...
* The creator or the legal entity’s representative must be a legal adult. Abide by the creator content guidelines
* Able to receive engagement payouts using Epic’s payment platform(s), currently Hyperwallet
...
## Hearthstone’s demanding creator program
...
* Direct communication with developers and early access to future content
* Giveaway codes and bundles to reward your community
* Special events like playtesting, invitations, and live events
* Influencer-exclusive merch

### Hearthstone Creator Program Requirements

While the benefits are fairly straightforward, their application requirements are slightly stricter than others.

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F92bd2273-0818-4203-ab3d-0220c3667ca6_597x780.png)

## Roblox Commits $35 Million to its Creator Fund.
...
### Roblox Creator Fund Requirements

The [creator fund](https://create.roblox.com/docs/creator-fund) is open to creators and developers who are looking to build unique projects on the platform.

* Multiplayer-focused
* Cross-platform with mobile optimization in mind
* Social mechanics as key to the experience
* Strong retention, monetization, and live operation plans,
* In-experience avatars that reflect elements of the user’s platform avatar identity. Ability to leverage items that you can equip on platform avatars, like the ones you buy in the Marketplace.
...
Read more about the [program here](https://create.roblox.com/docs/creator-fund) and [apply here](https://roblox.qualtrics.com/jfe/form/SV_a4PdqU3StYp6crI).

## Key Takeaways for Creator Programs
...
Supercell attributes its new game’s success to having face-to-face meetups with creators to get direct balance feedback for their new game, Squad Busters. It’s not enough to address complaints. To actually build trust, you have to implement their feedback. Whether it was the lack of variety or broken items, Supercell incorporated their feedback into the game. They even invited [100 creators](https://mobilegamer.biz/how-supercells-creator-program-helped-shape-squad-busters/) to their Helsinki office on launch day. That’s how genuine relationships are made.
