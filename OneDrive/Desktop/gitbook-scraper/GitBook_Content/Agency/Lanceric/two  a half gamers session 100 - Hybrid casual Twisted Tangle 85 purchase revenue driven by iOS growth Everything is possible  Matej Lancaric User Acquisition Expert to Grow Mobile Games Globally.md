...
# two & a half gamers session #100 – Hybrid casual Twisted Tangle: 85% purchase revenue driven by iOS growth? Everything is possible!
...
**Summary**  
In this episode, Matej, Jakub, and Felix discuss the game Twisted Tangle. They celebrate their 100th episode and talk about their recent event in Istanbul. They then dive into the unique gameplay and mechanics of Twisted Tangle, a physics-based puzzle game. They discuss the success of the game and its revenue numbers. Finally, they explore the changes made to the game and how it has evolved over time. The conversation delves into various aspects of the game, including its difficulty and progression, monetization strategies, ad placements, and revenue analysis. It also explores the target audience, user acquisition channels, and creative concepts used in the game’s marketing. The hosts provide their insights and observations on these topics, offering a comprehensive review of the game’s performance and potential.
