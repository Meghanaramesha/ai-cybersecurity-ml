# How to soft launch a mobile game in 2022? – Matej Lancaric: User Acquisition Expert to Grow Mobile Games Globally 🦄🕺
...
The other benefit of [concept testing](https://lancaric.me/how-to-save-millions-with-marketability-testing/) is its flexibility. To enhance your learnings, you can  use surveys. To obtain player feedback, you can create a redirect on the test app store page that directs people to a survey. These questions can cover game mechanics, characters, feature set, core loop, monetisation, spending behaviour, how often players play games and more. These survey questions are invaluable to:
...
The **step-by-step guide** on how to do marketability tests can be found [here](https://lancaric.me/how-to-save-millions-with-marketability-testing/)!
...
While in the Technical stage, we are mostly focusing on [data health](https://lancaric.me/how-to-check-your-games-ua-data/), crash rate and tracking in general, in the Retention stage we measure D1, D3, D7 Retention (duh!), FTUE, tutorial completion rate and much more..

![](https://lancaric.me/wp-content/uploads/2022/01/unnamed-7.png)

Game developers are obsessed with achieving the highest D1 retention numbers they can, but D1 is not the holy grail. I’ve seen games with D1 retention around 25% still being able to generate 2 million EUR a month. The magic was behind really good D60 retention, which was 6-8%. Therefore, it is absolutely crucial to focus on the ratio between D1, D3 and D7. Joakim described [multiple scenarios here](https://elitegamedevelopers.com/scenarios-for-soft-launch/), definitely check them out.
...
Let’s not forget about the Ad monetisation. In this stage, you should already have cracked the rewarded video ad placement. Now you are playing around with setting up waterfalls and [combining floors with bidders.](https://lancaric.me/ua-creative-learnings-comments-2021/)
