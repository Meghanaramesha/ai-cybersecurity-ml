...
![User Acquisition predictions](https://lancaric.me/wp-content/uploads/2023/05/lancito_crystal_ball_postapocalyptic_world_inside_the_ball_old__452e9d07-62c1-4a0e-b576-84985498dd2d.png) 
...
User acquisition (UA) is poised for a transformative year in 2023, as evolving technologies, shifting platform dynamics, and new consumer behaviors redefine strategies. From the growing influence of generative AI in creative media and app store optimization (ASO) to innovative onboarding approaches, UA professionals are exploring groundbreaking ways to engage and retain users. Generative AI is revolutionizing creative production, enabling the rapid generation of assets like icons, feature graphics, and descriptions, while hypercasual games continue to demonstrate resilience, adapting to changes in privacy regulations such as ATT and IDFA.

Connected TV (CTV) is emerging as a powerful channel in digital advertising, offering new opportunities for engagement, while user-generated content (UGC) and playable ads are enhancing trust, retention, and engagement within games. Meanwhile, SKAN 4.0 and Privacy Sandbox introduce uncertainty but also potential in mobile marketing, challenging marketers to adapt their attribution and targeting strategies. Predictions of hypercasual gaming’s decline have been countered by its adaptation and resilience, especially in the post-IDFA era.

The rise of the metaverse and genre-blending in 4X games signals a shift in how games are developed and marketed, creating fresh opportunities for growth. As TikTok continues to gain dominance, overtaking Facebook in certain aspects, UA strategies are evolving to navigate this shift and capitalize on the platform’s unique advantages. With these predictions in mind, 2023 promises to push the boundaries of user acquisition, presenting both challenges and opportunities for those ready to innovate and thrive in this competitive landscape.
...
The only predictions that are actually based on the real data are [the ones written by Deconstructor of Fun](https://www.deconstructoroffun.com/blog/category/Predictions). That’s the only thing you should care about. **Full stop!**
...
## The Impact of Generative AI on Creative Media and ASO
...
![](https://lancaric.me/wp-content/uploads/2022/12/IMG_3712-911x1024.jpg)  
![](https://lancaric.me/wp-content/uploads/2022/12/IMG_3715-912x1024.jpg)  
![](https://lancaric.me/wp-content/uploads/2022/12/IMG_3714-924x1024.jpg)  
![](https://lancaric.me/wp-content/uploads/2022/12/IMG_3716-912x1024.jpg)
...
![](https://lancaric.me/wp-content/uploads/2022/12/Screen-Shot-2022-12-10-at-10.19.10-1024x624.png)

A shit ton of startups are now working on applying **generative AI** to more complex media formats, including audio (text-to-speech, music), 3D modelling, video, and animation.

[Here](https://www.futurepedia.io/) is the is the largest AI tools directory. Browse 350+ AI tools in various categories like marketing, image generation and video editing.

![](https://lancaric.me/wp-content/uploads/2022/12/chat-whisperoor.png)

Generative AI is going to be used mostly in ASO for generating icons, feature graphics and writing descriptions. Everybody can see that already. We are still a bit far from video, but who knows right?

## The Resilience and Evolution of Hypercasual Games

How many times have we heard this? This is something that comes up pretty often in all the discussions. It was supposed to die because of the [recent Google Interstitial policies](https://www.businessinsider.in/tech/news/google-cracks-down-on-annoying-ads-in-games-to-enforce-stricter-guidelines-from-september-30/articleshow/93204862.cms). Guess what? **Nothing happened!**

Looking at the number of downloads for few hypercasual developers, doesn’t look like they are slowing down. Remember, hypercasual game developers are hustlers. Trying to find loopholes all the time! They won’t die easily and without the fight.

![](https://lancaric.me/wp-content/uploads/2022/12/Popcore_Rollic_1200x627_1-1024x535.jpeg)

In November 2022, Rollic has acquired Popcore, an independent mobile game developer based in Germany. A leader in the puzzle genre, Popcore is home to chart-topping games such as Parking Jam 3D and Pull the Pin!, both of which achieved the status of being among the #1 most downloaded games in the U.S. Apple App Store.

**IMHO!** This acquisition suggest exactly the opposite of death for this genre.

## The Rise of User-Generated Content in Gaming and User Acquisition
...
![](https://lancaric.me/wp-content/uploads/2022/12/UGC.jpeg)

Opera event started producing this type of creative a long time ago. Before it was cool! Now with TikTok emerging as a great UA channel, everybody is talking about UGC. Now we have companies like [Babblestock founded by my friend Toby](https://babblestock.com/?sca_ref=2914717.9aJ0QE4xMf), that help UGC-ify your UA videos easily.

Honestly, it doesn’t work for every game out there.

Also, don’t you dare thinking that slapping a creator on top of your UA video will [save your game](https://youtu.be/BKyjxR8t_qg).

## The Rise of Connected TV (CTV) as a Game-Changer in Digital Advertising

Heard of CTV? No?

Connected Television and its bedfellow OTT (Over The Top) refer to the TV device and the content streamed over the internet to watch long form television programming. It encompasses subscription-based Video On Demand streaming services like [Netflix](http://netflix.com) or [Disney+](https://www.disneyplus.com/home) and Advertising-based Video On Demand streaming services like Hulu or Pluto TV.
...
## The Uncertainty and Potential of SKAN 4.0 and Privacy Sandbox in Mobile Marketing
...
![](https://lancaric.me/wp-content/uploads/2022/12/Screen-Shot-2022-12-10-at-14.41.36-1024x522.png)

There is also a very limited amount of information regarding Privacy Sandbox, but at least Google relies on contributions from many companies testing the new technologies

## ATT, IDFA, and the Predicted “End” of Hypercasual Gaming
...
## The Rise of Playable Ads and UGC: Enhancing Retention, Trust, and Engagement
...
[Survey](https://www.nosto.com/blog/report-consumer-marketing-perspectives-on-content-in-the-digital-age/) also says UGC impacts their purchasing decisions as it humanises the brand and raises its trustworthiness. This is popular in the e-commerce and brand space. Still waiting for a survey amongst gamers. **Would it be the same?**

![](https://lancaric.me/wp-content/uploads/2022/12/playables.jpeg)  
Facebook  
Twitter  
LinkedIn  
 [Subscribe now to podcast](https://www.youtube.com/channel/UCpu7cyygnCCCkUEMG2-JiHQ)

## The Evolution of the Metaverse: Challenges, Opportunities, and Predictions for 2023
...
“Responsible Metaverse” capabilities, bridging the gap between technology, design, ethics, and politics, will become a differentiator and enabler for Metaverse companies, similar to “Responsible AI” capabilities in the AI field.

![](https://lancaric.me/wp-content/uploads/2022/12/the-invasion-is-imminent.jpeg)

Yeah yeah yeah Metaverse here, Metaverse there… bla,bla. 2023 is the year of the Metaverse, it will grow exponentially. **Again!**

## Debunking the Myth: The Resilience of Mobile F2P in the Post-IDFA Era
...
So you ease up the competition for us, non believers. **Thank you very much!**

![](https://lancaric.me/wp-content/uploads/2022/12/ai-meme.jpeg)

I guess this is very much connected to all the bullshit around IDFA Apocalypse. Here is actually a guide how to run profitable UA on iOS14 because **I love you**. To return the love, **subscribe to my newsletter!**

https://youtu.be/Xjro-REU8ws

## The Shift from Facebook to TikTok: Navigating UA Challenges and Opportunities
...
Here comes the game changer! [TikTok is going to be the new Facebook](https://lancaric.me/11-tips-for-killer-user-acquisition-ops-q4-version/) in terms of UA channel mix / diversification and we will see advertisers moving there **heavily in 2023**.

No shit, Sherlock.

## The Game-Changing Strategy of Genre-Blending in 4X Games: Bonus Prediction

As you might have understood already. I hate predictions and **in my humble opinion** any predictions made without data **is a big pile of shit**. Never the less, this is going to be the only prediction I will make for next year. [Same as I did the last year and it became true.](https://lancaric.me/ua-creative-learnings-comments-2021/)
...
My sense is that we will see this more and more next year from different genres and not only in those were we see high CPIs already (which is match3 and/or RPG)

**There you go – using different game genres (preferably those with low CPIs) as onboarding for your game. Thats it!**

If you are looking for data to back this up, [here you go](https://lancaric.me/user-acquisition-revolution-fake-ads-fake-core-gameplay/)!
