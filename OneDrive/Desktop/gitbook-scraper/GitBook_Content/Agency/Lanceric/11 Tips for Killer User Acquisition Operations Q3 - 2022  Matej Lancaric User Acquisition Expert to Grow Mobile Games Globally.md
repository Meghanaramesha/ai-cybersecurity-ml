...
# 11 Tips for Killer User Acquisition Operations Q3 – 2022
...
In quarter 3 of 2022, mobile game user acquisition has seen rapid advancements and evolving trends, reshaping how developers connect with players. Our ongoing series of quarterly UA Tips have explored the latest strategies, technologies, and industry shifts in user acquisition providing insights that help mobile game marketers stay ahead of the competition and maximize ROI more effectively.  
This article explores effective strategies for optimizing mobile game campaigns, focusing on various aspects of user acquisition, creative testing, and scaling. It covers optimizing Meta’s Advantage+ App Campaign setup, managing allowlists, and source-level bidding to achieve successful ROAS. It also includes approaches to creative testing for mobile games, collaborative scaling strategies, and addressing privacy requirements for iOS campaigns. Emphasis is placed on leveraging personas and proven creative strategies, avoiding common pitfalls during the soft launch phase, and enhancing ad reach and engagement on social media. The content underscores the importance of balancing budget, LTV, and campaign planning for scaling user acquisition, including key considerations for planning a global launch budget.

Here we go again! The [previous article was so successful](https://lancaric.me/12-tips-for-killer-user-acquisition-operations/), so I decided to write a follow up. Keep reading the tips to improve your UA. Simple, practical & efficient! That’s it, [no bullshit](https://www.youtube.com/channel/UCpu7cyygnCCCkUEMG2-JiHQ)!

## Optimizing Meta’s Advantage+ App Campaign Setup for User Acquisition Success
...
## Managing Allow list and Source Level Bidding for Successful ROAS Campaigns
...
Launch an **allow list** campaign (speak to your account manager to get best performing subids for your allowlist) or **source level bidding**(speak to your AM to get these bids)
...
## Creative Testing Strategies for Mobile Games
...
## Collaborative Strategies for Scaling a Game
...
## Meet Privacy Thresholds and Get SKAN Postbacks for iOS Purchase Campaigns
...
**Facebook** – min. installs per day per campaign 88 (it was 128 before, but now [FB guidelines](https://www.facebook.com/business/help/581721639581617?id=1716638325041491) say something different)
...
If you want to learn more about how to solve this issue, [check out this article](https://lancaric.me/user-acquisition-ios14-privacy-threshold-pass/)!

## Common Pitfalls When Expanding User Acquisition in Soft Launch: Avoid Wasting Budget in Unavailable Regions

You know this for sure. Running [UA in soft launch](https://lancaric.me/how-to-soft-launch-a-mobile-game-in-2022/) in limited countries. But you want to open up more for whatever reasons. (Creative testing, liquidity, CPI challenges, new localisation, new channel, you name it)
...
## Leveraging Personas and Proven Creative Strategies for Marketing Success
...
[The best performing creatives](https://www.youtube.com/watch?v=YFR-7qweHY0) are the ones taken from the hypercasual or casual genre. Look what works elsewhere, adapt to your game. Full stop!

Oh, one more thing. Don’t forget to **use static images** in your (Facebook) campaigns. They work super well!

## Challenges of Using Proxy Events for Purchase Optimization in Campaigns
...
## Effective Strategies for Enhancing Ad Reach and Engagement on Social Media Platforms
...
* **But you can start with what is working the best on FB or Google**
...
## Scaling User Acquisition: Balancing Budget, LTV, and Campaign Strategies

Reiterating again the same point you saw earlier!

You **can only scale your budget until the LTV allows** you to do so.

Scaling a game is not only a function of a [killer user acquisition operation](https://lancaric.me/12-tips-for-killer-user-acquisition-operations/). It is also a function of a LTV.
...
## Planning Your Global Launch Budget: Key Considerations and Strategies
...
**A) [soft launch KPIs](https://lancaric.me/how-to-soft-launch-a-mobile-game-in-2022/)**
...
* how much money do you have in your bank account available for [UA](https://lancaric.me/12-tips-for-killer-user-acquisition-operations/)?
...
**D) [creative framework](https://lancaric.me/creative-framework-in-the-post-idfa-world/)**
...
## What are the Challenges for User Acquisition Operations Q3 – 2022?

Privacy and Data Regulations: Stricter privacy laws (e.g., GDPR, CCPA) and changes in data collection practices (e.g., Apple’s App Tracking Transparency) have made user targeting more challenging, reducing visibility into user behavior and limiting advertisers’ ability to personalize ads effectively.

Increased Advertising Costs: The competition for ad space has continued to increase, particularly on popular platforms like Facebook, Google, and TikTok, leading to rising costs per acquisition (CPA) and requiring UA teams to optimize budgets more efficiently.

Platform Changes and Ad Attribution: Major updates by platforms like Meta, Google, and Apple have caused shifts in how campaigns are tracked and attributed. Accurate measurement of campaign performance has become harder due to limited attribution windows, delayed data, and incomplete conversions tracking.

Economic Uncertainty: With economic uncertainty, potential customers may be more cautious with discretionary spending, making it harder to convert users and impacting the overall return on investment (ROI) for marketing campaigns.

Creative Fatigue: Users are bombarded with ads, leading to creative fatigue. Regularly refreshing creatives while maintaining effectiveness is challenging, particularly with increased costs for content production and influencer partnerships.

Limited Access to First-Party Data: Due to privacy concerns, first-party data is becoming increasingly critical. However, many companies still struggle to gather and leverage this data effectively for user acquisition strategies.

Channel Diversification: Diversifying user acquisition channels has become crucial to spread risk and capture audiences across different platforms. However, it presents challenges in allocating budget effectively, managing multiple platforms, and ensuring consistent messaging.

Algorithm Dependency: Increased reliance on machine learning algorithms for ad targeting by platforms such as Meta and Google means marketers have less manual control over targeting, and success depends on providing enough conversion data to train algorithms effectively.

## Anything that I missed?  [Subscribe now](https://www.youtube.com/channel/UCpu7cyygnCCCkUEMG2-JiHQ)
