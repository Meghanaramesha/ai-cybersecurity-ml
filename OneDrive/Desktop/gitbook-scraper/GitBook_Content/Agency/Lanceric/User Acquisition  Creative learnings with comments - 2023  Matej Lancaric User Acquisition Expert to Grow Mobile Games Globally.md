...
User Acquisition & Creative Learnings with Comments – 2023 is the ultimate guide to staying ahead in the ever-evolving world of mobile marketing. In 2023, user acquisition (UA) strategies witnessed a transformative shift, driven by innovations like TikTok Creative Challenges, AI-powered optimization tools like Google DV360, and the rise of adaptive ad creatives. This article dives deep into the essential techniques, tools, and trends reshaping how brands attract, engage, and convert users. From exploring the role of AI and machine learning in refining campaign strategies to understanding the nuances of organic versus paid UA, we cover it all. Whether you’re looking to boost your app downloads, optimize ad performance, or master micro-moments, these insights and expert commentary will empower you to elevate your marketing game.

In 2023, successful user acquisition (UA) hinged on producing high-performing creative videos and leveraging innovative strategies. To create winning video ads, focus on three key elements: a powerful hook in the first 1–4 seconds to capture attention, engaging meat that highlights gameplay or unique features, and a compelling call-to-action to drive user engagement. Platforms like TikTok proved transformative, especially through the TikTok Creative Challenge (TTCC), where creators submitted video ads for brand challenges, making authentic content a game-changer. Ensuring clear and detailed creative briefs was essential for generating quality submissions.

Creative pacing emerged as another vital factor. Testing different speeds revealed that slower, relaxing content resonated with female audiences, while action-packed, fast-paced creatives engaged males. Creative inspiration drew from competitors, hypercasual mechanics, ASMR trends, and memes, emphasizing the importance of unique and differentiated concepts. Meanwhile, UA channel strategies demonstrated the continued relevance of platforms like Facebook for early-stage testing, complemented by Google, Unity, TikTok, and Applovin for broader campaigns. On iOS, Automated App Ads (AAA) helped optimize campaigns by balancing installs and purchases, addressing the challenges of post-IDFA privacy changes.

In the soft launch phase, optimizing device targeting by excluding older models with insufficient RAM or outdated OS versions significantly improved performance. Monitoring retention ratios, such as D1, D7, and D30, provided more actionable insights than focusing solely on benchmarks. Seasonal creatives proved effective only when seamlessly integrated across ad visuals, app store pages, and in-game content. Building the right creative team structure, scaling production to match the UA budget, and balancing skill sets across motion designers, animators, and illustrators further streamlined campaign efforts.

Effective communication was pivotal, fostering collaboration across UA, product, and creative teams. Transparent, empathetic discussions ensured alignment on campaign performance and creative strategies. For iOS campaigns, patience during the initial 72-hour optimization period was critical to accommodate privacy thresholds and delayed postbacks. Consolidating geographies and leveraging broad targeting strategies helped meet these challenges.

Writing detailed creative briefs with defined project goals, audience insights, and comprehensive assets significantly enhanced creative outputs. Fake ads, though controversial, played a role during monetization, balancing low CPIs with high-value players through value optimization. Finally, maintaining a clear perspective on industry advice, prioritizing tasks effectively, and embracing innovation underscored the lessons of 2023. By adopting these strategies, UA managers can navigate the evolving landscape, ensuring campaign success and scalability.Started this tradition three years ago, half drunk after the Christmas dinner when I saw a lot of predictions flying around. I sat down and wrote about what I’d learned that year. Here we go again since you can’t predict almost anything in our ever-changing gaming industry!

Sit back, relax, grab a Christmas Margarita or eggnog, and enjoy the learnings of 2023 with my **lovely** comments!

But where to start? There were so many important things that worked so well. I already shared a bunch of them in my [previous tips](https://lancaric.me/11-tips-for-killer-user-acquisition-q3-version/), so this time I am going to mention those that made **the most impact on my UA ops**! It’s quite a lot of learnings, definitely get that eggnog. Here you go:

## What Makes a Video Ad Perform Well for Mobile Games?

A video ad performs well for mobile games when it effectively grabs user attention, showcases gameplay, and drives engagement.Producing a [creative winner](https://lancaric.me/creative-framework-in-the-post-idfa-world/) is not an easy job. Thank you, captain obvious! What a great start to the article. Nevertheless, So let’s look at the anatomy of a well-performing creative:

* Hook
* Meat
* Call to Action

![](https://lancaric.me/wp-content/uploads/2023/03/Screen-Shot-2023-03-15-at-20.46.05-1-1024x317.png)
...
[  ](https://lancaric.me/wp-content/uploads/2023/03/0bffc031f9e37b28c3ea6b70f99c7c73.mp4)

[  ](https://lancaric.me/wp-content/uploads/2023/03/2fc1925ef00ad32710d6f73bf0263283.mp4)

**Meat**

Attractions of the game itself are highly effective selling points of the game. Show gameplay recordings and share strategies, extraordinary characters, and your unique artistic style. Reveal the elements within your game that make it memorable and unique to new audiences. Also, you can use altered gameplay in your creatives. Not every level you show in the creative needs to be [in the game](https://lancaric.me/fake-ads-in-user-acquisition-the-untold-story/).

[![](https://lancaric.me/wp-content/uploads/2023/12/Screenshot-48.png)](https://open.substack.com/pub/lancaric/p/stay-ahead-in-ua-for-2024-my-top?r=7qqaf&utm_campaign=learningsarticle&utm_medium=web)
...
[  ](https://lancaric.me/wp-content/uploads/2023/03/162f0999e5af34462eb3ca88d356cc29.mp4)

[  ](https://lancaric.me/wp-content/uploads/2023/03/340d9a8e926a3aefcf7dddda2db8d482.mp4)

## What Is TikTok Creative Challenge and How Does It Work?

The TikTok Creative Challenge is a performance-driven advertising feature where brands collaborate with creators to promote products or services through unique, engaging content.Unlocking TikTok? Seems like a big challenge. Oh wait, have you said challenge? Do you mean TikTok Creative Challenge (TTCC)? Badumtss! Jokes aside. If you are not listed for a TTCC, you are missing out heavily.
...
## How Can You Leverage Effective Hooks in Your Creative Strategy for Better User Acquisition?

Effective hooks are critical for capturing audience attention and driving user acquisition. Here’s how to use them strategically:Hooks make a difference in your creatives. There are masters of hooks at Century Games using real-life hooks combined with their game Whiteout Survival. How could you leverage **hooks** a bit more in your creative strategy? Which one of these grabbed your attention?

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F54dba8dd-0bc0-4e26-a59b-3a3d460fa185_2314x1066.png)
...
## How Does Creative Pace Impact User Acquisition Metrics Across Different Audiences?

Creative pace directly influences user acquisition metrics by affecting how audiences engage with ads. Faster-paced creatives tend to capture the attention of younger, fast-scrolling audiences, while slower-paced creatives may resonate better with older or more detail-oriented users.How to improve creatives? There are 2389273872362 ways how to make that happen. What is not discussed too often, but has a significant impact on the performance (at least in my view) is the **pace of the creative**. What do I mean by that?
...
## Where Can You Find the Best Creative Inspiration for Ads?

Finding the best creative inspiration for ads involves exploring diverse platforms and resources where successful campaigns and innovative ideas thrive.Where to get creative inspiration? That is always the hard question. Maybe the hardest one! Lets dig a little bit deeper:
...
* **hypercasual mechanics**
  + yes, I know, I know. I am talking about this for ages already. Still works like a charm. Some games started even adding whole ([hypercasual) GAMES into their games](https://lancaric.me/user-acquisition-revolution-fake-ads-fake-core-gameplay/?utm_source=newsletterBH52&utm_medium=weeklytip&utm_campaign=mail)
* **Youtube vs TikTok trends**
  + ASMR (eating), save the dog, chest opening, dancing, etc.

https://youtu.be/CQAWVnCQIJw

* **Memes & hype (+AI shit)**

This category is endless inspiration. Use it wisely!

https://youtu.be/9p7P-dIGpwQ

## How Can ASMR Trends Boost User Acquisition in Mobile Gaming in 2023?

ASMR trends can significantly enhance user acquisition in mobile gaming by tapping into the sensory appeal and relaxation that ASMR content offers. Here’s how:This tip is focused on one creative concept I mentioned before. Could you guess what it is? Check the creatives below:

Yes! ASMR. I was talking about this multiple times last year on our [two & a half gamers podcast](https://www.youtube.com/@2.5gamers)! There was hype around the concept when the ASMR slicing game hit the top 1 in US downloads ranks, but then slowly faded off.

The trend is still pretty big, btw:

There are so many ASMR variations:

![](https://lancaric.me/wp-content/uploads/2023/05/Screen-Shot-2023-05-22-at-06.21.56-1024x958.png)

## How can you optimize User Acquisition (UA) strategies for ad revenue-based games?

To optimize UA strategies for ad revenue-based games, focus on attracting a large and engaged user base while balancing acquisition costs and ad performance.In the last few games UA reviews we did on the [Two & a half gamers no bullshit podcast](https://www.youtube.com/channel/UCpu7cyygnCCCkUEMG2-JiHQ/), we saw a strong performance of Applovin. It was on the top of the spending and share of impressions. It was paired with a strong performance of the playable ad format. Then we saw Google and Unity in the UA channel mix.
...
## How does effective communication drive success in User Acquisition?

Effective communication plays a crucial role in driving user acquisition by ensuring that the message resonates with the target audience and motivates them to take action. Key ways communication impacts UA success include:Communication is key to success not only in User Acquisition, but because it allows individuals, teams, and organizations to effectively share information, ideas, and feedback.
...
## What is the ideal creative team structure for effective user acquisition campaigns?

The ideal creative team structure for effective user acquisition (UA) campaigns should be collaborative and adaptable to rapidly changing trends and insights.I’ve been talking about how to identify trends in creatives multiple times. What I didn’t talk about too often is the creative team structure and the number of creatives they need to produce for a certain level of UA budget.
...
## How can memes boost user acquisition in gaming?

Memes can effectively boost user acquisition in gaming by leveraging humor, relatability, and viral potential to capture attention and engage audiences.When thinking about creative ideas, look around – ideally outside of gaming. Maybe browse a little bit on Facebook or Instagram. What is your go-to website for memes?

Try to leverage hype and buzz. Have you see a great meme or video that you could recreate for your game? Use it!

![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F00d835e1-d110-4ea5-b8da-79e90b2e8031_1015x980.png)

There are multiple other examples, but you get it right? The same applies to [AI-generated](https://lancaric.me/11-tips-for-killer-user-acquisition-q3-version/) images. **Short & dirty, but super efficient!**

## How can iOS 14+ privacy changes affect user acquisition campaigns?

The privacy changes introduced in iOS 14+ (specifically App Tracking Transparency, or ATT) have significant implications for user acquisition (UA) campaigns. Here’s how they affect campaign performance:  
...
![](https://substackcdn.com/image/fetch/w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff09ccffc-27b3-4108-9927-ff50c770bc00_1610x878.png)
...
## How can you craft a compelling creative brief to boost user acquisition for a mobile game launch?

Crafting a compelling creative brief for a mobile game launch is crucial for aligning the team and ensuring that the marketing materials resonate with the target audience.Alright, buckle up because I’m about to give you a crash course on writing a killer creative brief for your mobile app or game.
...
## What are the best user acquisition channels for early-stage F2P mobile games?

**The best user acquisition channels for early-stage F2P mobile games are as followed :Which UA channel to use for early-stage F2P mobile games and selecting appropriate UA channels for each launch phase?** This question appeared recently in our [2.5gamers slack channel.](https://join.slack.com/t/two-and-half-gamers/shared_invite/zt-26hqtman9-qvEmS3pU4GaXXx0jnzWvUQ)
...
![](https://lancaric.me/wp-content/uploads/2023/05/toppng.com-roll-safe-roll-safe-1241x1037-1.png)

## How can studying competitors’ creative strategies boost user acquisition performance?

Studying competitors’ creative strategies can significantly improve user acquisition (UA) performance by providing valuable insights and allowing for more informed decisions when crafting your own campaigns.
...
Just look at what Kingdom Guard is doing nowadays. They put a big target on Rush Royale, started copying their ads, and are almost on a third or fourth iteration of winners. Looks like it’s working well – [See for yourself!](https://lancaric.me/user-acquisition-creative-learnings-2022/)

## How does targeting high-performance devices improve mobile game soft launch retention?

Targeting high-performance devices during a mobile game’s soft launch can have a significant impact on user retention for several reasons:

When in [soft launch](https://lancaric.me/how-to-soft-launch-a-mobile-game-in-2022/), be sure to think about the whole picture.
...
How do you do that? My former colleagues [Martin](https://www.linkedin.com/in/martino-kovac/) & [Tomas](https://www.linkedin.com/in/tom%C3%A1%C5%A1-bel%C3%A1k/) did the hard work for you and compiled this [list](https://docs.google.com/spreadsheets/d/1UpFTAY5Feefr9Dw_xYpMXoUavs8F_IfhtkDLUQANeow/edit?usp=sharing) – Request access! Add these to your campaigns and voila, exclusion list is there.
...
## Are seasonal creatives effective in user acquisition campaigns?

Yes, seasonal creatives can be highly effective in user acquisition (UA) campaigns for mobile games.
...
It’s actually very similar to the [fake ads experience](https://lancaric.me/user-acquisition-revolution-fake-ads-fake-core-gameplay/) I have been talking about in the last couple of years
...
## What are the key KPIs for a successful mobile game soft launch?

The key KPIs for a successful mobile game soft launch are as followed :
...
## How does organizing game assets early improve User Acquisition for mobile games?

Organizing game assets early in the development process can have a significant impact on user acquisition (UA) campaigns for mobile games.
...
## How to spot misleading marketing advice?

Spotting misleading marketing advice is crucial for avoiding ineffective or harmful strategies that can waste resources and damage your brand.
...
But is that really true? How come [survivor.io uses the same creatives](https://lancaric.me/ua-creative-strategy-user-acquisition/) on all the channels and makes $2mil/day?
...
![](https://lancaric.me/wp-content/uploads/2023/12/main-qimg-696e2599a3b76dfb0c9c5900b52f471f-lq.jpg)

## When is it effective to use fake ads in mobile game user acquisition campaigns?

Fake ads are effective to use in mobile game user acquisition campaigns in following ways :

Should you even consider those?

There is no right answer to this question. Maybe it is in [here.](https://lancaric.me/hero-wars-fake-ads-false-advertising/) But if you are considering using something not completely related to your gameplay, wait until you are done with the retention tests in the soft launch. If you start using fake ads too soon, your retention will look like shit. And not because your game sucks, but because your creatives are misleading. They are setting different expectations, which in the retention phase is not very appreciated.
...
## What are the best strategies for running successful iOS campaigns?

The best strategies for running successful iOS campaigns are as followed : This was definitely a highlight of the year for me – **AGAIN**! I was invited to have a talk at Google x DOF event in Istanbul..
...
![](https://lancaric.me/wp-content/uploads/2023/12/paid.png)

[![](https://lancaric.me/wp-content/uploads/2023/12/Screenshot-48.png)](https://open.substack.com/pub/lancaric/p/stay-ahead-in-ua-for-2024-my-top?r=7qqaf&utm_campaign=learningsarticle&utm_medium=web)

## Matej AI

## How did ‘No Bullshit Gaming Podcast’ grow its subscriber base in 2023?

No Bullshit Gaming Podcast’ grow its subscriber base in 2023 by following ways:

This little baby has experienced explosive growth this year. Oh my fucking god! We did not expect such a great feedback. Our no-BS podcast is growing thanks to all of you and it pushes us forward. [Please subscribe to our channel](https://www.youtube.com/channel/UCpu7cyygnCCCkUEMG2-JiHQ), if you didn’t already. It would make the world to us since we are putting a lot of effort to produce high-quality content. It’s also so much fun!
...
![](https://lancaric.me/wp-content/uploads/2023/12/bgf8f8f8-flat750x075f-pad750x1000f8f8f8.jpg)
...
## How can building an inclusive community space enhance collaboration and innovation in the gaming industry?

Building an inclusive community space in the gaming industry can significantly enhance collaboration and innovation by creating an environment where diverse voices and perspectives are valued.Yes, we actually did this too. We opened up a community space for everybody. Juniors, seniors, developers, marketers, sales people, vendors. **The most inclusive community in gaming**! Join us [here](https://join.slack.com/t/two-and-half-gamers/shared_invite/zt-235cralar-rzJNo5gNa~yrYrrun7PDjQ).

## What are the key challenges faced by Mobile User Acquisition managers in 2024?

the key challenges faced by Mobile User Acquisition managers in 2024 are as followed : The year 2023 was wonderful, but for different reasons than you might think. It was a fucking hard year! As I mentioned in my Linkedin post below:

![](https://lancaric.me/wp-content/uploads/2023/12/Screenshot-47.png)

The fact that I started last year with 50% less monthly revenue was really hard. But it was an eye-opening experience, which I am super grateful for. I learned a lot about who I am, what is really important to me, and what I can achieve. This year it was very similar. The life of a consultant is a constant roller coaster. That why I [wrote about the reality of a UA manager](https://lancaric.me/ua-manager-life-post-idfa-reality/):
...
Effective time management can significantly improve work-life balance by helping individuals allocate their time efficiently across both professional and personal activities.This year, everybody asked me how I can handle all the things at the same time. Work, podcasts, blogs, newsletters, daughter. Last year taught me one important thing. **Everything is possible!** Being “busy” and not having time is just a state of mind. If you are struggling to find time, sit down, think about your processes, and activities, and organize your time better. **It’s a game of priorities!**

If I can be **2nd fastest growing technology company** in Slovakia, run a (paid) newsletter, [start my own AI](https://lancaric.me/matej-ai/), podcast and write frequently while spending 70% of the day with my little daughter, you are doing something really **wrong**.

![](https://lancaric.me/wp-content/uploads/2023/12/lanco_gifko_pf2024_v1.gif)

I guess that’s it for 2023! All of the above is what I’ve learned. But a lot was happening in my world.

## How can humor and personal engagement boost newsletter subscriptions and sharing?

Humor and personal engagement are powerful tools for boosting newsletter subscriptions and encouraging sharing. Here’s how they can enhance the success of your campaigns:Oh wow! You made it here! You must be very engaged. I like that type of players… Ehm, people!
